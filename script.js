const apiKey = 'sk-7T8kolOqREEWDfYsI4hxjKDqmK1C5qZrBUIdlyRqTxT3BlbkFJbUaod7VY8x8XTx-Ke8-fLxd1Rua3_3sfpFlUevY_IA'; // Replace with your actual API key
...
async function submitNewTicket(issueDescription) {
    ...
    const response = await fetch('https://7bcf-35-237-223-57.ngrok-free.app/add_ticket', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
